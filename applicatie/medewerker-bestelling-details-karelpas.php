...
<head>
    ...
    <title>Sole Machina | Medewerker Bestellingen Details</title>
</head>

<body>
    <header>
        <h1>Medewerker Bestellingen Details</h1>
    </header>
    ...
    <main>
        <section class="bestellingen">
            <h2>Bestellingen Details</h2>
            <div class="bestellingen-info">
                <div class="bestelling">
                    <h3>Bestelling van Karel Pas</h3>
                    <h4>Besteld om: 14:13</h4>
                    <h4>Online betaald</h4>
                    ...
                    <div class="bestelling-sub">
                        ...
                        <button onclick="location.href='medewerker-bestellingen.php '">Terug naar overzicht</button>
                </div>
            </div>
        </section>
    </main>
